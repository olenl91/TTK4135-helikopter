...
typedef helikopter03_rtModel RT_MODEL;

/*====================*
 * External functions *
 *====================*/
extern RT_MODEL * helikopter03(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(helikopter03_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://helikopter03:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: helikopter03 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
