 ...
 */
#ifndef RTW_HEADER_helikopter04_3_h_
#define RTW_HEADER_helikopter04_3_h_
#ifndef helikopter04_3_COMMON_INCLUDES_
# define helikopter04_3_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <math.h>
#include <string.h>
...
#endif                                 /* helikopter04_3_COMMON_INCLUDES_ */

#include "helikopter04_3_types.h"
...
#define helikopter04_3_rtModel         RT_MODEL_helikopter04_3
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } OptimalTrajectory_PWORK;           /* '<Root>/Optimal Trajectory' */
  ...
  struct {
    void *LoggedData;
  } Trajectory_PWORK;                  /* '<Root>/Trajectory' */
...
} ContinuousStates_helikopter04_3;
...
typedef struct {
  ...
  real_T TransferFcn5_CSTATE;          /* '<S2>/Transfer Fcn5' */
  real_T Integrator_CSTATE;            /* '<S1>/Integrator' */
} StateDerivatives_helikopter04_3;
...
#define rtB                            helikopter04_3_B
#define BlockIO                        BlockIO_helikopter04_3
#define rtX                            helikopter04_3_X
#define ContinuousStates               ContinuousStates_helikopter04_3
#define rtP                            helikopter04_3_P
#define Parameters                     Parameters_helikopter04_3
#define rtDWork                        helikopter04_3_DWork
#define D_Work                         D_Work_helikopter04_3

/* Parameters (auto storage) */
struct Parameters_helikopter04_3_ {
  ...
  real_T Gain_Gain[36];                /* Expression: eye(6)*pi/180
                                        ...
                                        */
  real_T Gain_Gain_h[12];              /* Expression: K
  ...
  real_T Saturation_LowerSat;          /* Expression: -10
                                        * Referenced by: '<S1>/Saturation'
                                        */
  real_T Saturation_UpperSat_k;        /* Expression: 50*pi/180
                                        * Referenced by: '<S4>/Saturation'
                                        */
  real_T Saturation_LowerSat_i;        /* Expression: -50*pi/180
                                        * Referenced by: '<S4>/Saturation'
                                        */
...
struct RT_MODEL_helikopter04_3 {
  const char_T *path;
...
extern Parameters_helikopter04_3 helikopter04_3_P;

/* Block signals (auto storage) */
extern BlockIO_helikopter04_3 helikopter04_3_B;

/* Continuous states (auto storage) */
extern ContinuousStates_helikopter04_3 helikopter04_3_X;

/* Block states (auto storage) */
extern D_Work_helikopter04_3 helikopter04_3_DWork;

/* Model entry point functions */
extern void helikopter04_3_initialize(boolean_T firstTime);
extern void helikopter04_3_output(int_T tid);
extern void helikopter04_3_update(int_T tid);
extern void helikopter04_3_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_helikopter04_3 *helikopter04_3_M;
 ...
 *
 * '<Root>' : helikopter04_3
 * '<S1>'   : helikopter04_3/Elevasjonskontroller
 * '<S2>'   : helikopter04_3/Heli 3D
 * '<S3>'   : helikopter04_3/LQR controller
 * '<S4>'   : helikopter04_3/Pitch-kontroller
 * '<S5>'   : helikopter04_3/V_d//V_s --> V_f//V_b
 */
#endif                                 /* RTW_HEADER_helikopter04_3_h_ */
